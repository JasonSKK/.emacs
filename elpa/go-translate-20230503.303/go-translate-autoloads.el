...
;;;***

;;;### (autoloads nil "gts-engine-stardict" "gts-engine-stardict.el"
;;;;;;  (0 0 0 0))
;;; Generated autoloads from gts-engine-stardict.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "gts-engine-stardict" '("gts-stardict-")))

;;;***

;;;### (autoloads nil "gts-engine-youdao" "gts-engine-youdao.el"
;;;;;;  (0 0 0 0))
;;; Generated autoloads from gts-engine-youdao.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "gts-engine-youdao" '("gts-youdao-dict-e")))
