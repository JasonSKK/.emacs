...
;;; Setting Variables
;; set primary address
(setq outlook-address1 "Iason.SvoronosKanavas@hud.ac.uk")
(setq outlook-name1 "Iason Svoronos Kanavas (Researcher)")

;; where outlook compli *.el files are and compli-scripts/ directory
(setq emacs-outlook-compli-directory "/Users/jsk/emacs-prelude-personal/postload/emacs-outlook-compli-mode")
;; set emacs archive directory, where csv is saved
(setq emacs-outlook-compli-archive-directory "/Users/jsk/outlook-mail")

;; ~/emacs-prelude-personal/postload/emacs-outlook-compli-mode/compli-scripts

(provide 'emacs-outlook-compli-mode)
;;; 031_emacs-outlook-compli-mode.el ends here
